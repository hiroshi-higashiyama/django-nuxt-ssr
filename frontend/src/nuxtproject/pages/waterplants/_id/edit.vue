      ...
      <div class="col-md-4">
        <form @submit.prevent="submitWaterPlant">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <select
                  v-model="waterplant.addition_amount"
                  class="form-control"
                >
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input
                  v-model="waterplant.leaf_length"
                  type="text"
                  class="form-control"
                  name="Positions"
                />
          ...
          <div class="form-group mb-3">
            <label for>水質</label>
            <input
              v-model="waterplant.water_quality"
              type="text"
              class="form-control"
              name="Positions"
            />
    ...
    async submitWaterPlant() {
      ...
      try {
        const response = await this.$axios.$patch(
          `/waterplants/${editedWaterPlant.id}/`,
          formData,
          config
        );
